...
> Microsoft Foundry は https://ai.azure.com/nextgen からアクセスできます。
...
> メモリ設定時に **[メモリを有効にするには、埋め込みモデルを設定してください]** というメッセージが表示される場合は、画面右上ツールバーの **ビルド** > 左メニューバーの **モデル** をクリックしてモデルの一覧画面を開き、text-embedding-3-small などの埋め込みモデルが存在することを確認してください。(通常は Foundry リソースを新規作成すると、gpt-4.1 と text-embedding-3-small がデフォルトで自動デプロイされます。)
> 埋め込みモデルが生成されていない場合は、[5.モデルの追加デプロイ](#5-モデルの追加デプロイ) の手順を参考にして text-embedding-3-small などの埋め込みモデルをデプロイしてください。
> ![](./images/1-2-06_02.png)
>
...
[Microsoft Foundry ポータル](https://ai.azure.com/nextgen) を開き、画面右上ツールバーの **ビルド** > 左メニューバーの **エージェント** の画面を開き、2 で作成したエージェントを参照します。
...
[Microsoft Foundry ポータル](https://ai.azure.com/nextgen) を開き、2 で作成したエージェントを参照します。
...
[Microsoft Foundry ポータル](https://ai.azure.com/nextgen) を開き、画面右上ツールバーの **ビルド** > 左メニューバーの **エージェント** から 1～3 で作成、編集したエージェントを開く
...
[Microsoft Foundry ポータル](https://ai.azure.com/nextgen) を開き、画面右上ツールバーの **ビルド** > 左メニューバーの **エージェント** を開き、1～6 で作成、編集したエージェントを開きます。
