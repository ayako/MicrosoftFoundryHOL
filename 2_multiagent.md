...
[Microsoft Foundry ポータル](https://ai.azure.com/nextgen) を開き、画面右上ツールバーの **ビルド** > 左メニューバーの **エージェント** の画面を開きます。**[エージェントの作成]** をクリックして、新規エージェントを作成します。
...
routing-agent で使うモデルには **gpt-4.1** を選択します。**手順**には以下のプロンプトを入力します。
...
microsoft-search-agent で使うモデルには **gpt-4.1** を選択します。**手順**には以下のプロンプトを入力します。
...
[Microsoft Foundry ポータル](https://ai.azure.com/nextgen) を開き、画面右上ツールバーの **ビルド** > 左メニューバーの **ワークフロー** 画面を開きます。 
